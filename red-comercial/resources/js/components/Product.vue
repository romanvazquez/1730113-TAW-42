    ...
    <div>
        <v-container>
            <div class="row">
                ...
                <v-carousel>
                    <v-carousel-item :src="require('../../../public/img/home/slider4.jpg')"></v-carousel-item>
                    <v-carousel-item :src="require('../../../public/img/home/slider2.jpg')"></v-carousel-item>
                    <v-carousel-item :src="require('../../../public/img/home/slider3.jpg')"></v-carousel-item>
                    <v-carousel-item :src="require('../../../public/img/home/slider1.jpg')"></v-carousel-item>
                </v-carousel>
                </div>
                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div class="pl-6">
                        ...
                        <v-card-actions class="pa-0">
                            ...
                            <span class="body-2	font-weight-thin"> 25 RESEÑAS</span>
                        </v-card-actions>
                        ...
                        <v-text-field type="number" outlined style="width:100px" :value="1" dense></v-text-field>
                        <v-btn class="primary white--text" outlined tile dense><v-icon>mdi-cart</v-icon>AGREGAR AL CARRITO</v-btn>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12 col-md-12">
                            ...
                            <v-list three-line="true" avatar="true">
                                <v-list-item-group v-model="item" color="primary">
                                    <v-list-item v-for="(item, i) in items" :key="i" inactive="true">
                                        ...
                                        <v-list-item-content>
                                            <v-list-item-title v-html="item.title"></v-list-item-title><v-rating v-model="rating" class="" background-color="warning lighten-3" color="warning" dense></v-rating>
                    ...
                    <v-card-text class="pa-0 pt-4" tile outlined>
                        <p class="subtitle-1 font-weight-light pt-3 text-center">TAMBIÉN PODRÍA GUSTARTE</p>
                        <v-divider></v-divider>
                        <div class="row text-center">
                            <div class="col-md-2 col-sm-4 col-xs-12 text-center">
                                <v-hover v-slot:default="{ hover }" open-delay="200">
                                    <v-card :elevation="hover ? 16 : 2">
                                        <v-img class="white--text align-end" height="200px" :src="require('../../../public/img/home/deal1.jpg')">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 text-center" >
                                <v-hover v-slot:default="{ hover }" open-delay="200">
                                    <v-card :elevation="hover ? 16 : 2">
                                        <v-img class="white--text align-end" height="200px" :src="require('../../../public/img/home/deal2.jpg')">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 text-center" >
                                <v-hover v-slot:default="{ hover }" open-delay="200">
                                    <v-card :elevation="hover ? 16 : 2" >
                                        <v-img class="white--text align-end" height="200px" :src="require('../../../public/img/home/deal3.jpg')">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 text-center" >
                                <v-hover v-slot:default="{ hover }" open-delay="200">
                                    <v-card :elevation="hover ? 16 : 2">
                                        <v-img class="white--text align-end" height="200px" :src="require('../../../public/img/shop/5.jpg')">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 text-center" >
                                <v-hover v-slot:default="{ hover }" open-delay="200">
                                    <v-card :elevation="hover ? 16 : 2">
                                        <v-img class="white--text align-end" height="200px" :src="require('../../../public/img/home/deal4.jpg')">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 text-center" >
                                <v-hover v-slot:default="{ hover }" open-delay="200">
                                    <v-card :elevation="hover ? 16 : 2">
                                        <v-img class="white--text align-end" height="200px" :src="require('../../../public/img/shop/3.jpg')">
            ...
            <v-container>
                ...
                <v-col class="col-12 col-md-4 col-sm-12">
                    ...
                    <v-col class="col-12 col-sm-9 pr-4">
                        <h3 class="font-weight-light">Envíós seguros y devoluciones.</h3>
                                    <p class="font-weight-thin">Envío gratis a partir de compras de $300</p>
                    </v-col>
                    </v-row>
                </v-col>
                <v-col class="col-12 col-md-4 col-sm-12">
                    ...
                    <v-col  class="col-12 col-sm-9 pr-4">
                        <h3 class="font-weight-light">Trato directo con productores.</h3>
                        <p class="font-weight-thin">Consigue los mejores precios.</p>
                    </v-col>
                    </v-row>
                </v-col>
                <v-col class="col-12 col-md-4 col-sm-12">
                    ...
                    <v-col  class="col-12 col-sm-9 pr-4">
                        ...
                        <p class="font-weight-thin">Soporte disponible para las dudas más comunes entre los usuarios.</p>
                    </v-col>
                    </v-row>
                </v-col>
                </v-row>
