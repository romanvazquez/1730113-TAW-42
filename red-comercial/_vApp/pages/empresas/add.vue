...
export default {
    beforeCreate() {
        ...
        /* 
        * Se definen las URL que establecen comunicación entre la vista (cliente) y el controlador (servidor)
        ...
        */
        ...
        if (this.$router.history.current.params && this.$router.history.current.params.id) {
            ...
            * La respuesta de esta promesa (dada por el método correspondiente en el controlador, dictado por la URL) asigna:
            */
            return this.$axiosx.get(url)
            .then((res) => {
                
                // Inicializa los datos de 'empresa' y 'dirección' 
    ...
    methods: {
        ...
        getHeading () {
            // Si la variable está definida en data y tiene un nombre definido, enotnces retornar el nombre para la cabecera
        ...
        added() {
            ...
            if (this.$router.history.current.query.added == 'true') {
                ...
                this.$store.commit('snackbar', {
                    status: 'success',
                    text: 'La empresa ha sido agregada.'
                });
            }
        }
    }
