...
var _default = (0, _mapElement.default)({
  ...
  beforeCreate: function beforeCreate(options) {
    ...
    var position = this.position && google.maps.ControlPosition[this.position] ? google.maps.ControlPosition[this.position] : google.maps.ControlPosition.TOP_LEFT;
  ...
  methods: {
    ...
    drawAll: function drawAll() {
      ...
      this.shapes.forEach(function (shape) {
        ...
        shapeDrawing.setMap(_this3.$map);
